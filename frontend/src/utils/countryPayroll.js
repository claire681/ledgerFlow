...
var COUNTRIES = {
  CA: {
    ...
    taxFields: [
      ...
      { k: "federalTD1", l: "Federal TD1 claim amount", t: "money", placeholder: "Example: 16,129", help: "Enter the total from Line 13 of the employee's federal TD1 form. Most employees claim only the basic personal amount ($16,129 for 2025).", helpLink: { label: "View federal TD1 form", url: "https://www.canada.ca/en/revenue-agency/services/forms-publications/td1-personal-tax-credits-returns/td1-forms-pay-received-on-january-1-later.html" }, validate: rangeValidate(0, 999999), errorMsg: "Enter $0 to $999,999" },
      { k: "provincialTD1", l: "Provincial TD1 claim amount", t: "money", placeholder: "Example: 22,323", help: "Enter the total from the employee's provincial TD1 form. Each province has its own (TD1AB for Alberta, TD1ON for Ontario, etc.).", helpLink: { label: "View provincial TD1 forms", url: "https://www.canada.ca/en/revenue-agency/services/forms-publications/td1-personal-tax-credits-returns.html" }, validate: rangeValidate(0, 999999), errorMsg: "Enter $0 to $999,999" },
