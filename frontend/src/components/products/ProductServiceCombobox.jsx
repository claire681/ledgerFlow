    ...
    <div ref={containerRef} style={{ position: "relative", width: "100%" }}>
      ...
      {isOpen && (
        <div style={{ position: "absolute", top: "calc(100% + 2px)", left: 0, minWidth: 280, background: "#fff", border: "1px solid #e2e8f0", borderRadius: 6, boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 30, maxHeight: 320, overflowY: "auto" }}>
          <button type="button" onClick={() => { setIsOpen(false); if (onAddNew) onAddNew(); }} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "10px 14px", background: "#fff", border: "none", borderBottom: "1px solid #f1f5f9", fontSize: 13, fontWeight: 500, color: "#2563eb", cursor: "pointer", fontFamily: "inherit", textAlign: "left" }}>
