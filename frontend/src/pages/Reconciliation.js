...
import {
  ...
  Search, Sparkles, ArrowRight, Calendar,
    ...
    <div style={page}>
      ...
      <div style={{ ...topBar, flexDirection:isMobile?'column':'row', alignItems:isMobile?'flex-start':'center', gap:isMobile?10:0, padding:isMobile?'16px':undefined }}>
        ...
        <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
          ...
          <button onClick={() => askAndOpen(`I have ${txns.length} transactions. ${totalUnmatched} are unmatched and ${totalFlagged} are flagged. Help me reconcile my books.`)}
            ...
            if (isMobile) {
              return (
                <div key={t.id} onClick={() => toggleSelect(t.id)}
                  style={{ padding:'14px 16px', borderBottom:`1px solid ${L.border}`, background:isSel?L.accentSoft:'transparent' }}>
