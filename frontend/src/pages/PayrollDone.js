  ...
  if (error || !run || !totals) {
    return (
      <div style={{ padding: "40px 32px", background: C.page, minHeight: "100vh", fontFamily: FONT }}>
        ...
        <button onClick={function() { navigate("/payroll/pay-runs"); }} style={{ padding: "10px 16px", background: C.card, border: "1.5px solid " + C.ink, borderRadius: 10, color: C.ink, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: FONT }}>Back to Pay Runs</button>
      </div>
    );
  }
    ...
    <div style={{ maxWidth: "100%", margin: 0, padding: "28px 32px 110px", fontFamily: FONT, background: C.page, minHeight: "100vh" }}>
      <div style={{ background: C.card, borderRadius: 12, padding: "40px 48px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 32px", borderTop: "1px solid " + C.line, position: "fixed", bottom: 0, left: 0, right: 0, background: C.card, zIndex: 100, boxShadow: "0 -4px 12px rgba(0,0,0,0.06)" }}>
          <button onClick={function() { navigate("/payroll/pay-runs"); }} style={{ padding: "12px 18px", background: C.card, border: "1.5px solid " + C.ink, borderRadius: 10, color: C.ink, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: FONT, display: "inline-flex", alignItems: "center", gap: 6 }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            }} style={{ padding: "12px 24px", background: C.brand, border: "none", borderRadius: 10, color: C.card, fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: FONT, boxShadow: "0 1px 2px rgba(18,38,43,0.12)" }}>Print all pay stubs</button>
          </div>
        </div>
