...
import T4EmployeeSlips from "./pages/T4EmployeeSlips";
...
import PayrollDrafts from "./pages/PayrollDrafts";
  ...
  return (
    <div style={{
      ...
      <div style={{ display:'flex', flex:1, overflow:'hidden', position:'relative' }}>
        ...
        {!(location.pathname.startsWith("/invoices/new") || location.pathname.match(/^\/invoices\/[^/]+\/(edit|send)$/) || location.pathname.startsWith("/payroll/taxes/t4-preview") || location.pathname.match(/^\/payroll\/run\/[^/]+/)) && (
            <div data-print="hide">
            <Sidebar
          onLogout={onLogout}
      ...
      <Route path="/payroll/bank-accounts" element={<BankAccounts />} />
        ...
        <Route path="/payroll/employees" element={<EmployeesList />} />
          ...
          <Route path="/payroll/schedules" element={<PaySchedules />} />
          <Route path="/payroll/drafts" element={<PayrollDrafts />} />
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#F8FAFC' }}>
        <div style={{ textAlign: 'center' }}>
          <img src="/logo-mark-header.png" alt="Novala" style={{ height: 40, width: 'auto', objectFit: 'contain', marginBottom: 8 }} />
