...
CANADA_DEFAULT_PAY_TYPES = [
    ...
    {
        "name": "Stat pay ADW",
        "description": "Average daily wage paid for statutory holidays (auto calculated)",
        "calc_method": "adw",
        "default_rate": None,
        "unit_label": "auto calculated",
        "federal_taxable": True,
        "cpp_contributable": True,
        "ei_insurable": True,
        "vacationable": True,
    ...
    {
        "name": "Hourly 2",
        "description": "Second hourly rate for secondary jobs or roles",
        "calc_method": "rate_hours",
        "default_rate": None,
        "unit_label": "per hour",
        "federal_taxable": True,
    ...
    },
    {
        ...
        "description": "Double time (2x) for stat holidays and contract overtime",
        "calc_method": "rate_hours",
        "default_rate": None,
        "unit_label": "per hour (2.0x)",
        "federal_taxable": True,
        "cpp_contributable": True,
        "ei_insurable": True,
        "vacationable": True,
    ...
    {
        "name": "Controlled tips",
        "description": "Tips collected and distributed by the employer",
        "calc_method": "fixed",
        "default_rate": None,
        "unit_label": None,
        "federal_taxable": True,
    ...
    {
        "name": "Allowance",
        "description": "Fixed allowance (phone, uniform, tools, etc.)",
        "calc_method": "fixed",
        "default_rate": None,
        "unit_label": None,
        "federal_taxable": True,
